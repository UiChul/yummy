...
def get_shots_from_sequence(sequence):
    """
    특정 시퀀스에서 샷 가져오기
    """
    sg = connect_sg()
...
def generate_project_folders(project_name, sequences, steps):
...
# {seq}_{shot}_{step}_folder_structure
    for seq in sequences:
        ...
        shots = get_shots_from_sequence(seq)
...
folders = generate_project_folders(project_name, sequences, steps)
