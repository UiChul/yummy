...
class ShotgridUpload:
    ...
    # 샷그리드 연결
        ...
        # ver_data = {
        #         'project': {'type': 'Project', 'id': 123},  # 프로젝트 ID
        #         'code': 'Example Version',  # 버전 코드
        #         'description': 'This is an example version',  # 설명
        #         'entity': {'type': 'Shot', 'id': 456},  # 엔티티 ID
        # }

        shotgun.Shotgun(link, script_name, script_key).create('Version', ver_data)
    ...
    #     }
    #     # self.sg.upload('Version', entity_id = "")
    #     # mov_file = '/Users/lucia/Desktop/4Codes/1Project/test_v001.mov'
    #     # self.sg.upload('Version', entity_id = "Content", path = mov_file, field_name = "sg_ddd", display_name = None)
    #     # print(ver_data)
    #     return ver_data


    # def sg_create_ver(self, ver_data):
