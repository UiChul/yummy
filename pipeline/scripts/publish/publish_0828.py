...
class Publish(QWidget):
    ...
    def __init__(self):
        ...
        self.ui.pushButton_publish.clicked.connect(self.copy_to_pub_from_dev)
...
#==================================================================
    ...
    def _find_server_dev_path(self):
        ...
        # tablewidget에 세팅된 original version 기준으로 server_path 재료 찾기
    ...
    def _find_server_pub_path(self):
        ...
        for path in ver_up_server_dev_paths:
            ...
            print(f"{pub_path}:펍패스")
            ver_up_server_pub_paths.append(pub_path)
        print(f"{ver_up_server_pub_paths}:리스트")
