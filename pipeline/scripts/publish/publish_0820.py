...
class Publish(QWidget):
    ...
    def set_exr_file_list(self):
        ...
        exr_file_list = self.ui.toolBox.findChild(QListWidget, "exr_file_list")
        if exr_file_list:
            ...
            for exr_file_name in exr_file_names:
                ...
                exr_file_list.addItem(exr_item)
    ...
    def set_mov_file_list(self):
        ...
        mov_file_list = self.ui.toolBox.findChild(QListWidget, "mov_file_list")
        if mov_file_list:
            ...
            for mov_file_name in mov_file_names:
                ...
                mov_file_list.addItem(mov_item)
    ...
    def display_thumbnail(self):
        ...
        scaled_thumbnail = thumbnail.scaled(193, 110, Qt.AspectRatioMode.KeepAspectRatio)
