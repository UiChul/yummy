...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.plainTextEdit = QPlainTextEdit(self.groupBox_shot_comment_2)
        self.plainTextEdit.setObjectName(u"plainTextEdit")
        self.plainTextEdit.setGeometry(QRect(0, 20, 231, 311))
        ...
        self.tabWidget_mytask_status.setCurrentIndex(0)
